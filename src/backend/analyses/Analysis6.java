...
public class Analysis6 extends AnalysisStrategy
{
	public Analysis6(int yearOne, int yearTwo)
	{
	...
	public Series[] getSeries(Context context)
	{
		...
		series[0] = new Series<Float>(type, "Ratio of Hospital beds (/1,000 people) to Current health expenditure (% of GDP");
		int currentYear;
