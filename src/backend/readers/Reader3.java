...
public class Reader3 extends ReaderStrategy
{
	int currentSeries;
	
	// make urls based on parameters
	public Reader3(int year1, int year2, String country)
	{
		...
		currentSeries = 2;
		urlString = String.format(
				"http://api.worldbank.org/v2/country/%s/indicator/NY.GDP.PCAP.CD?date=%d:%d&format=json", country, year1, year2);
		readAppropriateData();
	}
