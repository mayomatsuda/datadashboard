...
public class Reader6 extends ReaderStrategy
{
	int currentSeries;
	
	// make urls based on parameters
	public Reader6(int year1, int year2, String country)
	{
		data = new Data2Series<Float, Float>();
		
		currentSeries = 1;
		urlString = String.format(
				"http://api.worldbank.org/v2/country/%s/indicator/SH.MED.BEDS.ZS?date=%d:%d&format=json", country, year1, year2);
		readAppropriateData();
